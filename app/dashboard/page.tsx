...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // We can fire this even if data is loading, it's idempotent-ish (checks existence in backend)
    // But better to wait until we know we have a user from the query maybe?
    // Actually the query returns null if no user.
    // Let's just fire it. If it fails due to auth it's fine.
                  ...
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-6 md:p-8 flex flex-col justify-center">
                      ...
                      <div className="space-y-4">
                        ...
                        <Link href={`/courses/${activeCourse._id}/manage`} className="w-full md:w-auto px-8 py-3 bg-primary hover:bg-primary/90 text-white rounded-lg font-bold text-sm transition-all transform active:scale-95 flex items-center justify-center gap-2">
                          Resume Course
            ...
            <section>
              ...
              {courses.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <Link key={course._id} href={`/courses/${course._id}/manage`} className="bg-white dark:bg-[#1c1f27] border border-slate-100 dark:border-slate-800 rounded-xl p-4 hover:border-primary/50 transition-colors cursor-pointer group flex flex-col h-full">
